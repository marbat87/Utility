...
public class FloatingActionButton extends ImageButton {
    ...
    private final OnScrollChangedListener mOnScrollListener2 = new OnScrollChangedListener() {
    ...
    public void attachToScrollView(@NonNull ScrollView scrollView) {
        ...
        mScrollView.getViewTreeObserver().addOnScrollChangedListener(mOnScrollListener2);
    }
